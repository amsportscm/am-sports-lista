                ...
                {rows.map((row) => (
                  <div key={row.id} className="grid grid-cols-[1fr_70px_98px_30px] gap-2 items-center group">
                    ...
                    <input
                      ...
                      placeholder="00"
                      data-testid={`input-number-${row.id}`}
                    />
                    <button
                      ...
                      data-testid={`button-size-${row.id}`}
                    >
                ...
                <div className="grid grid-cols-4 gap-2">
                  {ADULT_SIZES.map(size => (
                    <button
                      ...
                      data-testid={`button-size-select-${size}`}
                    >
                      {size}
                    </button>
                  ))}
